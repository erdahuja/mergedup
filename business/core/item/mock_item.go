...
import (
	context "context"
	item "mergedup/business/core/item"
	reflect "reflect"
...
func (m *MockStorer) Create(ctx context.Context, itm item.Item) error {
	m.ctrl.T.Helper()
...
func (m *MockStorer) Query(ctx context.Context, filter item.QueryFilter) ([]item.Item, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorer) QueryByID(ctx context.Context, itemID int64) (item.Item, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorer) Update(ctx context.Context, itm item.Item) error {
	m.ctrl.T.Helper()
...
func (m *MockStorer) WithinTran(ctx context.Context, fn func(item.Storer) error) error {
	m.ctrl.T.Helper()
